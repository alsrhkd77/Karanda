            ...
            return Form(
              ...
              child: PageBase(
                children: [
                  ListTile(
                    title: TextFormField(
                      decoration: InputDecoration(
                        labelText: context.tr("adventurer hub.edit post.title"),
                      ),
                  ...
                  ListTile(
                    title: Text(
                      context.tr("adventurer hub.edit post.recruitment type"),
                    ),
                    contentPadding: const EdgeInsets.symmetric(
                      vertical: 8.0,
                      horizontal: 24.0,
                    ...
                    trailing: DropdownMenu(
                      ...
                      enabled: recruitment == null,
                      dropdownMenuEntries: RecruitmentType.values.map((value) {
                        return DropdownMenuEntry(
                          value: value,
                          label: context.tr(
                  ...
                  ListTile(
                    title: TextFormField(
                      decoration: InputDecoration(
                        labelText: context.tr("adventurer hub.edit post.slots"),
                      ),
                      autovalidateMode: AutovalidateMode.onUserInteraction,
                  ...
                  _GuildName(
                    ...
                    textEditingController: controller.guildNameTextController,
                  ),
                  ListTile(
                    title: TextFormField(
                      decoration: InputDecoration(
                        labelText:
                            context.tr("adventurer hub.edit post.discord link"),
                      ),
                      autovalidateMode: AutovalidateMode.onUserInteraction,
                      inputFormatters: [
                        FilteringTextInputFormatter.allow(
